    ...
    <div className="min-h-screen bg-[#ECEBE9] text-[#1A2A44]">
      ...
      <main className="mx-auto grid w-full max-w-6xl gap-12 px-6 py-16 md:grid-cols-2 md:items-center md:py-24">
        ...
        <section className="flex justify-center md:justify-end">
          <div className="w-full max-w-[480px] rounded-[48px] border-4 border-[#F2B705] bg-[#ECEBE9] p-5">
            <div className="rounded-[34px] border border-[#D7DEE8] bg-white p-5">
              ...
              <article className="mt-5 overflow-hidden rounded-2xl border border-[#D7DEE8] bg-[#F9FBFF]">
                <div className="h-1 w-full bg-[#F2B705]" />
                ...
                <div className="border-t border-[#D7DEE8] p-6">
                  <div className="mx-auto flex h-48 w-full max-w-[220px] items-center justify-center rounded-xl border border-[#D7DEE8] bg-white text-7xl">
                    🏛️
                  </div>
